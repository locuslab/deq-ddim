...
for seed in $(seq 1 100)
   do
       python main.py --config celeba_ls_opt.yml --model Diffusion --exp celeba-orig --image_folder celeba-inverse-t20-parallel --doc celeba-orig-ddim --ls_opt --timesteps 20 --ni --method default --lambda1 1 --lambda2 0 --lambda3 0 --seed $seed --tau 0.1 --use_wandb --no_augmentation --pg_steps 1 
   done
