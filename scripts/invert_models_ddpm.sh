...
for seed in $(seq 1 25)
   do
       python main.py --config bedroom_ls_opt_ddpm.yml --model DiffusionInversion --exp lsun_orig --image_folder lsun_bedroom_images --doc lsun_orig --ls_opt --timesteps 10 --ni --method default --eta 0.5 --lambda1 1 --lambda2 0 --lambda3 0 --seed $seed --tau 0.1 --no_augmentation --pg_steps 1 --use_pretrained --use_wandb
   done
...
for seed in $(seq 1 25)
    do
        python main.py --config church_ls_opt_ddpm.yml --model DiffusionInversion --exp lsun_orig --image_folder lsun_church_images --doc lsun_orig --ls_opt --timesteps 10 --ni --method default --eta 0.5 --lambda1 1 --lambda2 0 --lambda3 0 --seed $seed --tau 0.1 --no_augmentation --pg_steps 1 --use_pretrained --use_wandb
    done