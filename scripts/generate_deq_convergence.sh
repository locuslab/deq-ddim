...
python main.py --config church.yml --model Diffusion --exp church-orig-fid --image_folder fid-church-seq-batch-t25 --doc church --sample --fid --timesteps 50 --eta 0 --ni --method simple-seq --use_pretrained