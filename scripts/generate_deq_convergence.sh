...
python main.py --config cifar10.yml --model Diffusion --exp cifar10-orig-fid --image_folder samples-cifar10-and-t1000-long-new --doc cifar10 --sample --fid --timesteps 1000 --eta 0 --ni --method anderson --use_pretrained --skip_type quad
...
python main.py --config cifar10.yml --model Diffusion --exp cifar10-orig-fid --image_folder fid-cifar10-seq-t1000 --doc cifar10 --sample --fid --timesteps 1000 --eta 0 --ni --method simple-seq --use_pretrained --skip_type quad
...
python main.py --config cifar10.yml --model Diffusion --exp cifar10-orig-fid --image_folder fid-ddpm-cifar10-seq-t1000-verify --doc cifar10 --sample --fid --timesteps 1000 --ni --samply_type ddpm_noisy --use_pretrained --skip_type quad
